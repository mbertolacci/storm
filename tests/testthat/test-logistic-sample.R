...
test_that('.get_logistic_sample_prior sets distributions', {
    ...
    prior <- .get_logistic_sample_prior(NULL, DEFAULT_DISTRIBUTIONS, 1, 2, 1)
...
test_that('.get_logistic_sample_prior uses hierarchical prior when there is more than one level', {
    prior <- .get_logistic_sample_prior(NULL, DEFAULT_DISTRIBUTIONS, 2, 2, 1)
...
test_that('.get_logistic_sample_prior with gaussian process prior', {
    ...
    prior <- .get_logistic_sample_prior(base_prior, DEFAULT_DISTRIBUTIONS, 9, 2, 2)
    ...
    prior <- .get_logistic_sample_prior(base_prior, DEFAULT_DISTRIBUTIONS, 20, 2, 2)
    # If there are more than 10, default to max(10, n_levels / 10)
    expect_equal(prior$logistic$n_gp_bases, 10)
    prior <- .get_logistic_sample_prior(base_prior, DEFAULT_DISTRIBUTIONS, 200, 2, 2)
